...
function processFilesInDirectory(directoryPath) {
    ...
    files.forEach(file => {
        ...
        if (fs.statSync(filePath).isFile()) {
            ...
            const outputPath = path.join(config.WORDLIST_RULES_RESULTS_DIRECTORY, outputFileName);
